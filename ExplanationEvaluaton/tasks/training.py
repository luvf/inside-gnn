...
def train_graph(_dataset, _paper, args):
    ...
    #criterion = torch.nn.MSELoss()#weight=torch.tensor([0.2,0.8]))
    ...
    for epoch in range(0, args.epochs):
        ...
        for data in train_loader:
            ...
            #y =torch.tensor([1-data.y.numpy(),data.y.numpy()]).t().to(dtype=out.dtype)
        ...
        print(f"Epoch: {epoch}, train_acc: {train_acc:.4f}, val_acc: {val_acc:.4f}, train_loss: {train_loss:.4f}")
